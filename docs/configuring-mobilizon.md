...
Refer to [this page](https://framagit.org/kaihuri/mobilizon-docker/-/blob/master/env.template) on the official documentation for a complete list of Mobilizon's config options that you can put in `mobilizon_environment_variables_additional_variables`.
